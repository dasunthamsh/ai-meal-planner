...
export default function MealPlanner() {
    ...
    const generateMealPlan = async () => {
        ...
        const mockPlan = {
            breakfast: {
                name: `${dietaryPreference !== 'none' ? dietaryPreference + ' ' : ''}Breakfast`,
            ...
            lunch: {
                name: `${dietaryPreference !== 'none' ? dietaryPreference + ' ' : ''}Lunch`,
            ...
            dinner: {
                name: `${dietaryPreference !== 'none' ? dietaryPreference + ' ' : ''}Dinner`,
